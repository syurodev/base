...
<Callout type="warn" title="Design only — Phase 4 postponed pending sandbox">
...
`internal/sandbox` phải Implemented trước khi resume Hub. External plugins /
marketplace vẫn Phase 5–6. Một phần thiết kế ACP đã được xác thực bằng thực nghiệm
thật — các chỗ đó được đánh dấu rõ. Trạng thái implementation thật nằm ở
