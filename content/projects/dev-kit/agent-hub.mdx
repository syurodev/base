...
hiểm (Gateway/permission UI không chặn bash/fs nội bộ của agent). Ưu tiên engineering
tiếp theo là research/spike sandbox (bubblewrap / Seatbelt / Landlock, tham chiếu
`sandbox-runtime`, `nono`, `ai-jail`, …) trước khi resume Agent Hub. External plugins
