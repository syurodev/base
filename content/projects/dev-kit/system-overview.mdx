...
- Hook chỉ notify; hành động nhạy cảm phải qua Capability Gateway / Extension API.

Để xem trạng thái implementation hiện tại, xem [Implementation status](/dev-kit/implementation-status).
