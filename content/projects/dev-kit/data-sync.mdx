...
- Conflict resolve phía client đã có (xem mục dưới). Chưa có production backend;
  server arbitration / device revocation trên BE thật vẫn là scope còn lại.
...
<Cards>
  ...
  <Card title="Notes" href="/dev-kit/notes" description="Conflict resolve merge-notes" />
