...
<Callout type="info" title="Implemented — UI + bridge; MCP deferred">
...
`kafka:produce`). MCP tool surface, cluster-selection popup flow, và env confirmation
gate vẫn **design only** — xem [MCP / Agent](/dev-kit/mcp-agent) và
