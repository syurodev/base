...
adapter map field vào `vaultitem.Store` chung (cùng substrate với Database/SSH).
...
<Cards>
  ...
  <Card title="Connections" href="/dev-kit/connections" description="Cùng thin-adapter pattern" />
