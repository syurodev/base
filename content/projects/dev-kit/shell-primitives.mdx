...
- **Resize kéo-thả** — gutter trong suốt giữa 2 card có hit-area
  ...
  khoảng `MIN_PANEL_WIDTH`–`MAX_PANEL_WIDTH` (320–720px, **chốt từ trước khi
  có [Sidebar](/dev-kit/sidebar) — chưa tính trường hợp Sidebar bên trái
  cũng resize cùng lúc, xem Sidebar § Resize để biết open question về việc
  cộng dồn width**). Width sau khi kéo
