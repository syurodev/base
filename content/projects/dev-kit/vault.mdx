...
| Database | `db-profile` | `db-password` | [Connections](/dev-kit/connections) |
| SSH | `ssh-profile` | `ssh-secret` | [Connections](/dev-kit/connections) |
...
<Cards>
  ...
  <Card title="Connections" href="/dev-kit/connections" description="Database/SSH cùng pattern" />
