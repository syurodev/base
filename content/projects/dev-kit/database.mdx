...
| `DBListForeignKeys` | `db:query` | `profile:<id>` | FK khai báo thật, không kèm quan hệ suy đoán |
| `DBIndexSchema` | `db:query` | `profile:<id>` | full introspect + ghi cache |
| `DBGetSchemaCache` | `db:query` | `profile:<id>` | đọc cache; rỗng thì index một lần |
