...
bộ công việc đang ở trạng thái nào. Đặt board ở một tracker SaaS thì mọi thao
tác của agent phải đi qua network + credential ngoài vault, và thông tin dự án
proprietary rời khỏi máy ở **mọi** thao tác chứ không chỉ khi user muốn — trái
nguyên tắc local-first. Board local là mặc định; nối ra tracker của team là
việc chọn thêm, có [cầu riêng](/dev-kit/jira-bridge) và có preview.
...
- **Sync board sang tracker bên ngoài** — cần credential + network ngoài vault,
  thuộc module riêng: [Jira bridge](/dev-kit/jira-bridge) (Design) phủ Jira
  Cloud theo mô hình **một chiều theo từng board**. Linear/GitHub Issues chưa
  có thiết kế.
