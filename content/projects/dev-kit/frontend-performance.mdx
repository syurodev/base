...
- [Workbench tabs](/dev-kit/workbench-tabs) — tab store và quy tắc giữ view.
...
<Cards>
  <Card title="Workbench tabs" href="/dev-kit/workbench-tabs" description="Tab lifecycle hiện tại và state-preservation constraints" />
